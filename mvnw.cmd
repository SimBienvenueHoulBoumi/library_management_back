...
@REM This will be replaced by the mvnw.cmd script when the wrapper is downloaded
@REM End of extension

:endDownloadWrapper

for %%i in ("%JAVA_HOME%\bin\java.exe") do set "JAVACMD=%%i"
...
if "%ERROR_CODE%"=="0" goto endWithErrorCode
